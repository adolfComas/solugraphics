        ...
        $("#contactForm input,#contactForm textarea").jqBootstrapValidation({
            ...
            submitSuccess: function(a, t) {
                ...
                o.indexOf(" ") >= 0 && (o = e.split(" ").slice(0, -1).join(" ")), $.ajax({
                    ...
                    cache: !1,
                    success: function() {
                        $("#success").html("<div class='alert alert-success'>"), $("#success > .alert-success").html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;").append("</button>"), $("#success > .alert-success").append("Your message has been sent."), $("#success > .alert-success").append("</div>"), $("#contactForm").trigger("reset")
                    },
                    error: function() {
